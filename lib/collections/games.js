...
Meteor.methods({
  game: function(gameAttributes) {
    ...
    var game = _.extend(_.pick(gameAttributes, 'gameTitle', 'scoreMax', 'playersIn', 'playersMax', 'spectatorsIn', 'spectatorsMax', 'gamePass', 'gameStatus', 'decks', 'playerList', 'spectatorList'), {
      userId: user._id,
